  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      Supervisor.child_spec(
        {Fleetlm.CircuitBreaker, name: :db_circuit_breaker, failure_threshold: 5, recovery_time: 30_000},
        id: :db_circuit_breaker
      ),
      Supervisor.child_spec(
        {Fleetlm.CircuitBreaker, name: :cache_circuit_breaker, failure_threshold: 3, recovery_time: 10_000},
